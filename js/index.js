...
function readCondition() {
   ...
   var keys = 'ap,ke,ce,te,en,weight_cap,legs_move,legs_stab,legs_turn,head_stab,head_cam,head_scan,arms_stab,arms_cap,core_supp'.split(',');
...
function search() {
   ...
   var label = 'HEAD,CORE,ARMS,LEGS,AP,KE防御,CE防御,TE防御,消費EN,重量,余剰積載,射撃安定,格納,移動制御,姿勢制御,旋回性能,安定演算,カメラ,スキャン'.split(',');
   var frame = [];
      ...
      for (var ic = 0, nc = parts.CORE.length; ic < nc; ic++) {
         ...
         for (var ia = 0, na = parts.ARMS.length; ia < na; ia++) {
            ...
            for (var il = 0, nl = parts.LEGS.length, _tmp; il < nl; il++) {
               ...
               // console.log(_tmp[10], condition.weihgt_cap_min, condition.weihgt_cap_max);
